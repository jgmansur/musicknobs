...
const MK_QUOTE_CATALOG = [
  ...
  { id: 'arte', title: 'Arte y Diseño', services: [
    ...
    { id: 'pintura-acrilica-chico', name: 'Pintura Acrílica sobre Lienzo – Chico', description: 'Tu imagen o la portada de tu disco en pintura acrílica sobre lienzo. Medida estándar 0.80 × 1.00 m, ajustable al espacio (no tiene que ser cuadrada; para portada de disco puede ser más grande).', priceLabel: '$12,000 MXN · 0.80 × 1.00 m', hasQty: true, qtyLabel: 'Obras', basePrice: 12000, currency: 'MXN' },
    { id: 'pintura-acrilica-mediano', name: 'Pintura Acrílica sobre Lienzo – Mediano', description: 'Tu imagen o la portada de tu disco en pintura acrílica sobre lienzo. Medida estándar 1.20 × 1.20 m, ajustable al espacio (no tiene que ser cuadrada; para portada de disco puede ser más grande).', priceLabel: '$15,000 MXN · 1.20 × 1.20 m', hasQty: true, qtyLabel: 'Obras', basePrice: 15000, currency: 'MXN' },
    { id: 'pintura-acrilica-grande', name: 'Pintura Acrílica sobre Lienzo – Grande', description: 'Tu imagen o la portada de tu disco en pintura acrílica sobre lienzo. Medida estándar 1.50 × 1.20 m, ajustable al espacio (no tiene que ser cuadrada; para portada de disco puede ser más grande).', priceLabel: '$20,000 MXN · 1.50 × 1.20 m', hasQty: true, qtyLabel: 'Obras', basePrice: 20000, currency: 'MXN' },
  ]},
...
const MK_QUOTE_CATALOG_LOCAL = [
  ...
  { id: 'arte', title: 'Arte y Diseño', services: [
    ...
    { id: 'fotografia-profesional', name: 'Fotografía Profesional', description: 'Sesión con fotógrafo profesional y cámaras de gama alta.', priceLabel: 'A cotizar', hasQty: false, basePrice: 0, currency: 'quote' },
    { id: 'pintura-acrilica-chico', name: 'Pintura Acrílica sobre Lienzo – Chico', description: 'Tu imagen o la portada de tu disco en pintura acrílica sobre lienzo. Medida estándar 0.80 × 1.00 m, ajustable al espacio (no tiene que ser cuadrada; para portada de disco puede ser más grande).', priceLabel: '$12,000 MXN · 0.80 × 1.00 m', hasQty: true, qtyLabel: 'Obras', basePrice: 12000, calcPrice: (q) => q * 12000, currency: 'MXN' },
    { id: 'pintura-acrilica-mediano', name: 'Pintura Acrílica sobre Lienzo – Mediano', description: 'Tu imagen o la portada de tu disco en pintura acrílica sobre lienzo. Medida estándar 1.20 × 1.20 m, ajustable al espacio (no tiene que ser cuadrada; para portada de disco puede ser más grande).', priceLabel: '$15,000 MXN · 1.20 × 1.20 m', hasQty: true, qtyLabel: 'Obras', basePrice: 15000, calcPrice: (q) => q * 15000, currency: 'MXN' },
    { id: 'pintura-acrilica-grande', name: 'Pintura Acrílica sobre Lienzo – Grande', description: 'Tu imagen o la portada de tu disco en pintura acrílica sobre lienzo. Medida estándar 1.50 × 1.20 m, ajustable al espacio (no tiene que ser cuadrada; para portada de disco puede ser más grande).', priceLabel: '$20,000 MXN · 1.50 × 1.20 m', hasQty: true, qtyLabel: 'Obras', basePrice: 20000, calcPrice: (q) => q * 20000, currency: 'MXN' },
  ]},
  { id: 'estudio', title: 'Estudio Profesional · exclusivo seguimiento', services: [
