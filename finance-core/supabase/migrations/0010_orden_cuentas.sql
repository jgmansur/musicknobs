...
update accounts set sort_order = 7  where name = 'Tarjeta de Crédito LikeU';
update accounts set sort_order = 8  where name = 'Mercado Pago Crédito';
update accounts set sort_order = 9  where name = 'Kueski';
